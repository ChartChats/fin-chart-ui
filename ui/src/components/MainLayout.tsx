...
export function MainLayout() {
  ...
  const [chartsWidth, setChartsWidth] = useState(0); // Will be calculated
        ...
        <div className="flex h-full w-full">
          ...
          {visibleSections.charts && (
            ...
            >
              ...
              {visibleSections.screener && <ResizeHandle section="charts" side="left" />}
              {visibleSections.chat && <ResizeHandle section="charts" side="right" />}
            </div>
          )}
